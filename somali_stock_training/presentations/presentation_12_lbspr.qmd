...
-   **SPR ≈ 1.0 (or 100%)**: Unfished stock, maximum reproductive output.
...
:::: {.columns}
::: {.column width="50%"}
1.  **📊 Length Frequency Data**: A representative sample of the lengths of fish caught from the stock.
