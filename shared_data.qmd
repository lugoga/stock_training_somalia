...
The following histograms show the size distributions of fish by group, excluding Rays and Skates.
...
lw |> 
    ...
    add_histogram(binwidth = 5, boundary = 0, fill = '#4CAF50', alpha = 0.85) |> 
    adjust_size(width = 1.5, height = 1.5, unit = 'in') |> 
